            ...
            <div className="bg-elevated/30 border border-white/[0.06] p-5 grid grid-cols-12 gap-4">
              ...
              <div className="col-span-12 md:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <div className="font-display text-lg">{usage.workspaces || snap.workspaces.length || 1}</div>
                </div>
                <div>
                  <div className="text-[10px] uppercase tracking-[0.3em] font-mono text-zinc-500 mb-1">Team</div>
                  <UsageBar used={usage.team || 0} cap={limits.team} />
                </div>
              </div>
            </div>
