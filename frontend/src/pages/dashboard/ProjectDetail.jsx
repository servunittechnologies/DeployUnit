...
export default function ProjectDetail() {
  ...
  if (!project) return <div className="p-6 text-zinc-500 font-mono text-sm">Loading project…</div>;
    ...
    <div data-testid="project-detail">
      ...
      {project.apps.length === 0 ? (
        <div className="m-6 border border-dashed border-white/10 p-16 text-center">
          <h3 className="font-display text-2xl">No apps in this project yet</h3>
          <p className="mt-2 text-zinc-400">Create an app and assign it to this project.</p>
        </div>
      ) : (
